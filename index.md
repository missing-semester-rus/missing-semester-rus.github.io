...
Вы можете предлагать исправления и корректировки существующих переводов [в GitHub репозитории русской версии проекта](https://github.com/missing-semester-rus/missing-semester-rus.github.io/pulls). Спасибо за помощь!
